...
export class OctoInvalidProductIdError extends OctoError {
  ...
  public constructor(productId: string, message?: string) {
    const body = {
...
export class OctoInvalidOptionIdError extends OctoError {
  ...
  public constructor(optionId: string, message?: string) {
    const body = {
...
export class OctoInvalidUnitIdError extends OctoError {
  ...
  public constructor(unitId: string, message?: string) {
    const body = {
...
export class OctoInvalidAvailabilityIdError extends OctoError {
  ...
  public constructor(availabilityId: string, message?: string) {
    const body = {
...
export class OctoInvalidBookingUUIDError extends OctoError {
  public uuid: string;
  public constructor(uuid: string, message?: string) {
    const body = {
