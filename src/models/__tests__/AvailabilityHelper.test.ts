  ...
  describe("checkAvailability", () => {
    ...
    it("should throw NoAvailabilityError due to non existing localDateTimeStart", async () => {
      const checkAvailability = () => {
        AvailabilityHelper.checkAvailability(availabilyPOJOs, "2023-12-10T00:00:00+01:00");
      };
    ...
    it("should throw NoAvailabilityError due to unavailability", async () => {
      const checkAvailability = () => {
        AvailabilityHelper.checkAvailability(availabilyPOJOs, unavailableLocalDateTimeStart);
      };
